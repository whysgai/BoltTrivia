...
io.on("connection", client => {
    io.sockets.emit("notify all", `Client ${client.id} has joined`);

    client.on("pizzas", msg => {
        console.log(`Client ${client.id} wants ${msg} pizzas`);
        client.emit("delivery", msg + " pizzas");
    })
})
